...
class PrivateHires extends StatelessWidget {
  static final String title = 'Private Hires';
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        body: Container(
          child: Column(children: <Widget>[
            ...
            SizedBox(height: 16),
            Text(
              'Private Hire of the JR Zone facility is an ideal treat for a fun family party, for friends and colleagues, or for social groups.',
              style: TextStyle(
                  color: Colors.black,
                  fontSize: 17,
                  letterSpacing: 1.5,
